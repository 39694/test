<?php
// ============================================================
// หมายเหตุ: ไฟล์นี้ใช้ "ข้อมูลตัวอย่าง (sample data)" ที่ประกาศไว้ตรงๆ
// ในโค้ด แทนการดึงจากฐานข้อมูลภายนอก เพื่อให้สามารถรันได้ทันที
// โดยไม่ต้องพึ่ง connect.php หรือ MySQL server ใดๆ
// ============================================================
